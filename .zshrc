...
# Set default zsh cache dir and create one if it does not exist
...
# Set default zsh history file
HISTFILE="${ZSH_CACHE_DIR}/zsh_history"

# Set default zsh completion cache file
...
plugins=(git sudo web-search dirhistory colored-man-pages command-not-found)
